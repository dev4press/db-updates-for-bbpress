...
SELECT 
   ...
   IF (mf.meta_value IS NULL, 0, CAST(mf.meta_value AS UNSIGNED)) AS total_reply_count,
...
LEFT JOIN wp_postmeta mf ON mf.post_id = p.ID AND mf.meta_key = '_bbp_total_reply_count'
